      ...
      <header className="topbar">
        ...
        <div className="room-status">
          {room.isAdmin ? <div className="admin-game-controls">
            ...
            <button className="tournament-control" disabled={Boolean(pending) || room.transferWindow.status === "open"} onClick={() => void stopAuction()} aria-label="Move to tournament simulator" title={everyTeamHasMinimumSquad ? "End auction and open Tournament Setup" : "Creator override: move to Tournament Setup before every team reaches 11 players"}><Trophy size={14} /><span>MOVE TO TOURNAMENT</span></button>
